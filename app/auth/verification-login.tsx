    ...
    <SafeAreaView className="flex-1 items-center justify-around gap-8">
      <View className="mt-5 flex-col items-center gap-4">
        ...
        <View className="mt-8 gap-2">
          <Text className="text-primary-foreground-light ml-1">手机号</Text>
          ...
          <Button onPress={() => router.push('/auth/verification-code')} className="h-14 w-72 rounded-full my-2">
            <Text className="text-xl text-white">发送验证码</Text>
          </Button>
          <Text className="text-center text-sm text-primary-foreground-light">未注册手机号会直接帮您注册</Text>
        </View>
      </View>
      <View className="mb-10 flex flex-col items-center justify-center gap-4">
        <Button className="rounded-full bg-white aspect-square" variant={'outline'}>
          <Icon as={AppleIcon} />
        </Button>
      </View>
    </SafeAreaView>
